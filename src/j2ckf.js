...
(function(ROOT, struct, undefined) {
    ...
    function getKeyframesRule(rule) {
        ...
        if (typeof rule == 'string') {
            ...
            ruleText = getKeyframesRule(
                rule.reduce(function(obj, text) {
    ...
    struct.prototype = {
        ...
        clear: function() {
            slice.call(this.cssRules).forEach(
                function(rule) {
    ...
    var extend = {
        ...
        remove: function(name) {
            iterateSheet(function(rule, i, sheet) {
                if (rule.name == (name.name || name)) sheet.deleteRule(i);
            });
...
})(typeof window === 'undefined' ? global : window, function(name, keys) {
